...
public class PopularListAdapter2 extends RecyclerView.Adapter<PopularListAdapter2.Viewholder> {
    ...
    @NonNull
    @Override
    public PopularListAdapter2.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PopularListAdapter2.Viewholder holder, int position) {
