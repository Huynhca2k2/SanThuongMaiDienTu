...
public class OrderListAdapter2 extends RecyclerView.Adapter<OrderListAdapter2.Viewholder> {
    ...
    Context context;
    public OrderListAdapter2(ArrayList<Order> items) {
        this.items = items;
    }
    ...
    @NonNull
    @Override
    public OrderListAdapter2.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_order_list2, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull OrderListAdapter2.Viewholder holder, int position) {
        ...
        holder.statusOrderTxt.setText("Success");
